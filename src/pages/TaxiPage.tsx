...
import carGlanza from "@/assets/Toyato-glanza 4 seater.jpeg";
import carCrista from "@/assets/Toyato-crista 6seater.jpeg";
import carFortune from "@/assets/commercial Toyato fortuner.jpeg";
import carReion from "@/assets/toyato renion.jpeg";
...
const fallbackVehicles: SanityVehicle[] = [
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?w=900&q=85&fit=crop",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1570125909232-eb263c188f7e?w=900&q=85&fit=crop",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=900&q=85&fit=crop",
...
const trustPoints = [
  {
    ...
    desc: "Police-verified, licensed local drivers with years of mountain experience.",
  },
  {
    icon: Clock,
    title: "24/7 Available",
    desc: "Airport pickups at 3 AM or late-night drops — always on time.",
  },
  {
    icon: Star,
    title: "4.9★ Rated",
    desc: "Trusted by 500+ happy travelers every season.",
  },
  {
    icon: Car,
    title: "Well-maintained Fleet",
    desc: "Clean, AC vehicles inspected before every single trip.",
  },
  {
    icon: Users,
    title: "Group Friendly",
    desc: "From solo trips to 27-seater buses — we have you covered.",
  },
  {
    icon: CheckCircle2,
    title: "No Hidden Charges",
    desc: "The price quoted is the price you pay. Always.",
  },
];
...
const TaxiPage = () => {
  ...
  const handleBook = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: "Your booking details are pre-filled.",
    });
  };
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[72vh] min-h-[500px] flex items-center overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 pt-20">
          ...
          >
            Safe, comfortable & affordable cabs to every corner of Kashmir &
            Ladakh.
          </p>
          <p
          ...
          >
            Verified drivers · Clean vehicles · No hidden charges
          </p>
          <div
          ...
          >
            ...
            <a href="tel:9682553190">
              <Button
                size="lg"
                className="bg-white text-primary hover:bg-white/90 gap-2 px-8 font-semibold"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto text-sm">
              From budget sedans to luxury SUVs and large group travellers — all
              rates are <strong className="text-foreground">per day</strong> (8
              hrs / ~250 km).
            </p>
          </div>
            ...
            {vehicles.map((v) => (
              ...
              >
                <div className="relative h-44 overflow-hidden">
                  ...
                  />
                  <span
                    className={`absolute top-3 left-3 text-xs font-bold px-2.5 py-1 rounded-full ${v.tagColor}`}
                  >
                    {v.tag}
                  </span>
                </div>
                ...
                <div className="p-4 flex flex-col flex-1">
                  <h3 className="font-serif font-bold text-foreground text-base mb-0.5">
                    {v.name}
                  </h3>
                  ...
                  <a
                    href={`https://wa.me/919682553190?text=${encodeURIComponent(`Hi, I want to book a ${v.name} cab in Kashmir.`)}`}
                    target="_blank"
          ...
          <p className="text-center text-xs text-muted-foreground mt-6">
            * Per-day rate covers 8 hours and up to 250 km. Extra hours/km
            billed at nominal rate. Ladakh permit charges extra.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-sm max-w-md mx-auto">
              One-way fares for a sedan. Larger vehicles priced proportionally.
              Return trips at discounted rates.
            </p>
          </div>
                ...
                <div className="flex items-center justify-end gap-2">
                  ...
                  >
                    <Button
                      size="sm"
                      variant="outline"
                      className="h-7 text-xs border-primary text-primary hover:bg-primary hover:text-primary-foreground px-3"
                    >
                      Book
                    </Button>
                  </a>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {trustPoints.map((t) => (
              <div
                key={t.title}
                className="flex gap-4 items-start bg-card border border-border/50 rounded-xl p-5"
              >
            ...
            <div className="space-y-5">
              <div className="bg-primary rounded-2xl p-7 text-primary-foreground">
                ...
                <p className="text-primary-foreground/70 text-sm mb-5">
                  Call us directly — our team confirms your cab instantly, 24
                  hours a day.
                </p>
                <a href="tel:9682553190">
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="mt-10 text-center bg-accent/40 rounded-2xl p-8 border border-border/50">
            ...
            <p className="text-muted-foreground text-sm mb-5">
              Our team is available 24/7 to help plan your Kashmir taxi.
            </p>
            <div className="flex flex-wrap justify-center gap-3">
              ...
              >
                <Button
                  variant="outline"
                  className="border-green-600 text-green-600 hover:bg-green-600 hover:text-white gap-2"
                >
